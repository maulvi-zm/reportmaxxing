...
import { CreateReportInput, ReportCategory, ReportVisibility } from '../types/report';
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.field}>
          ...
          <View style={styles.optionRow}>
            {categories.map((item) => (
              ...
              >
                <Text style={[styles.optionText, category === item && styles.optionTextSelected]}>
                  {item}
                </Text>
              </Pressable>
            ))}
        ...
        <View style={styles.field}>
          ...
          <View style={styles.optionRow}>
            {visibilities.map((item) => (
              <Pressable
                ...
                style={[styles.option, visibility === item && styles.optionSelected]}
              >
                <Text style={[styles.optionText, visibility === item && styles.optionTextSelected]}>
                  {item}
                </Text>
              </Pressable>
            ))}
          ...
          <Text style={styles.helper}>
            ...
            {visibility === 'PRIVATE' && 'Only visible to you and officials.'}
            {visibility === 'ANONYMOUS' && 'Visible to public, but anonymous.'}
          </Text>
        </View>
